(function ($) {
    ...
    var bricks = {
        ...
        slidersInit: function () {
            ...
            var fullScreenSlider = $(".fullscreen_slider");

            fullScreenSlider.revolution({
                sliderType: fullScreenSlider.attr('data-type') ? fullScreenSlider.data('type') : "standart",
                ...
                navigation: {
                    arrows: {
                        style: 'white-arrows',
                        enable: fullScreenSlider.attr('data-arrows') ? fullScreenSlider.data('arrows') : true,
                        hide_onleave: false,
                    },

                    bullets: {
                        enable: fullScreenSlider.attr('data-arrows') ? fullScreenSlider.data('bullets') : false,
                        style: "side-bullets",
                        hide_onleave: true,
                        hide_delay: 200,
            ...
            var fullWidthSlider = $(".fullwidth_slider");
            fullWidthSlider.revolution({
                sliderType: fullWidthSlider.attr('data-type') ? fullWidthSlider.data('type') : "standart",
                sliderLayout: "fullwidth",
                delay: 9000,
                navigation: {
                    arrows: {
                        style: 'white-arrows',
                        enable: fullWidthSlider.attr('data-arrows') ? fullWidthSlider.data('arrows') : true,
                        hide_onmobile: true,
                    }
                },
                gridwidth: fullWidthSlider.attr('data-width') ? fullWidthSlider.data('width') : 1920,
                gridheight: fullWidthSlider.attr('data-height') ? fullWidthSlider.data('height') : 860,
                disableProgressBar: "on"
            });
